...
public class onTouchRecyclerItemHelper extends ItemTouchHelper.SimpleCallback {
    private onTouchRecyclerItemListener itemTouchHelpListener;

    public onTouchRecyclerItemHelper(int dragDirs, int swipeDirs, onTouchRecyclerItemListener listener) {
